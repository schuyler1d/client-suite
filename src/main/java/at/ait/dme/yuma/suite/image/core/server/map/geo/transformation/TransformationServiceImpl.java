...
package at.ait.dme.yuma.suite.image.core.server.map.geo.transformation;
...
import at.ait.dme.yuma.suite.image.core.client.server.TransformationService;
...
public class TransformationServiceImpl extends RemoteServiceServlet implements TransformationService {
	...
	@Override
	public List<WGS84Coordinate> transformCoordinates(String mapUrl, List<XYCoordinate> xyCoords)
