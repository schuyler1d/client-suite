...
package at.ait.dme.yuma.suite.apps.image.core.client.drawing.shape;
...
import at.ait.dme.yuma.suite.apps.image.core.client.drawing.dnd.Resizable;
import at.ait.dme.yuma.suite.apps.image.core.client.drawing.dnd.ResizeDragController;
import at.ait.dme.yuma.suite.apps.image.core.client.drawing.shape.handler.PolygonDrawMouseHandler;
import at.ait.dme.yuma.suite.apps.image.core.client.drawing.shape.handler.PolylineDrawMouseHandler;
import at.ait.dme.yuma.suite.apps.image.core.client.drawing.shape.handler.ShapeMouseListenerAdapter;
...
public class ShapePanel extends AbsolutePanel implements Resizable {	
	...
	public void markSelected(boolean selected) {
		if (selected) {
			...
			graphicsPanel.setColor(new Color(shape.getColor().getR(), shape.getColor().getG(),
					shape.getColor().getB()));
		}
		drawShape();
	}
