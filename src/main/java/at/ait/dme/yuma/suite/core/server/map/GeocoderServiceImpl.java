...
package at.ait.dme.yuma.suite.core.server.map;
...
import at.ait.dme.yuma.suite.core.client.server.GeocoderService;
import at.ait.dme.yuma.suite.core.client.server.exception.GeocoderException;
import at.ait.dme.yuma.suite.core.client.server.exception.TransformationException;
import at.ait.dme.yuma.suite.core.server.map.transformation.AffineTransformation;
import at.ait.dme.yuma.suite.core.server.map.transformation.ControlPointManager;
import at.ait.dme.yuma.suite.core.server.map.transformation.CoordinateTransformation;
import at.ait.dme.yuma.suite.core.server.map.transformation.TransformationResult;
