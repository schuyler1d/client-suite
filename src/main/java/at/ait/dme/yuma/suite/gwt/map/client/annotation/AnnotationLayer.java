...
package at.ait.dme.yuma.suite.gwt.map.client.annotation;
...
import at.ait.dme.yuma.suite.gwt.core.client.datamodel.SemanticTag;
import at.ait.dme.yuma.suite.gwt.core.client.gui.events.selection.AnnotationSelectionEvent;
import at.ait.dme.yuma.suite.gwt.image.client.YumaImageClient;
...
import at.ait.dme.yuma.suite.gwt.image.core.client.tagcloud.TagSelectionListener;
import at.ait.dme.yuma.suite.gwt.image.core.client.tagcloud.annotation.TagEnabledAnnotationForm;
import at.ait.dme.yuma.suite.gwt.map.client.MapComponent;
import at.ait.dme.yuma.suite.gwt.map.client.MapUtils;
import at.ait.dme.yuma.suite.gwt.map.client.server.GeocoderService;
import at.ait.dme.yuma.suite.gwt.map.client.server.GeocoderServiceAsync;
import at.ait.dme.yuma.suite.gwt.map.client.server.exception.TransformationException;
