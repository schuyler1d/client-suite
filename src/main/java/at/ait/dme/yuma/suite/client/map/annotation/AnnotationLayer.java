...
public class AnnotationLayer {
	...
	private void addGeonamesSuggestions(Bounds bbox) {
		...
		service.getTags(Application.getImageUrl(), new XYCoordinate((int)bbox.getLeft(), (int)bbox.getBottom()), new XYCoordinate((int)bbox.getRight(), (int)bbox.getTop()), new AsyncCallback<SemanticTag[]>(){
