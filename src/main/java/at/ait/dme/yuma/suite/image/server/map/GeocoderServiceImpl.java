...
package at.ait.dme.yuma.suite.image.server.map;
...
import at.ait.dme.yuma.suite.image.client.server.exception.GeocoderException;
import at.ait.dme.yuma.suite.image.client.server.exception.TransformationException;
import at.ait.dme.yuma.suite.image.server.map.transformation.AffineTransformation;
import at.ait.dme.yuma.suite.image.server.map.transformation.ControlPointManager;
import at.ait.dme.yuma.suite.image.server.map.transformation.CoordinateTransformation;
import at.ait.dme.yuma.suite.image.server.map.transformation.TransformationResult;
