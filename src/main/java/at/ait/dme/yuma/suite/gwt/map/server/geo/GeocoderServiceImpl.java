...
package at.ait.dme.yuma.suite.gwt.map.server.geo;
...
import at.ait.dme.yuma.suite.gwt.core.server.Config;
import at.ait.dme.yuma.suite.gwt.map.client.annotation.WGS84Coordinate;
import at.ait.dme.yuma.suite.gwt.map.client.annotation.XYCoordinate;
import at.ait.dme.yuma.suite.gwt.map.client.server.GeocoderService;
import at.ait.dme.yuma.suite.gwt.map.client.server.exception.GeocoderException;
import at.ait.dme.yuma.suite.gwt.map.client.server.exception.TransformationException;
import at.ait.dme.yuma.suite.gwt.map.server.geo.transformation.AffineTransformation;
import at.ait.dme.yuma.suite.gwt.map.server.geo.transformation.ControlPointManager;
import at.ait.dme.yuma.suite.gwt.map.server.geo.transformation.CoordinateTransformation;
import at.ait.dme.yuma.suite.gwt.map.server.geo.transformation.TransformationResult;
...
public class GeocoderServiceImpl extends RemoteServiceServlet  implements GeocoderService {	
	 ...
	 * Properties
	 */
	private static final String GOOGLE_API_KEY_PROPERTY = "map.google.api.key";
