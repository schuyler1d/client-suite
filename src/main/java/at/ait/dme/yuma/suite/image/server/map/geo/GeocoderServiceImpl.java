...
package at.ait.dme.yuma.suite.image.server.map.geo;
...
import at.ait.dme.yuma.suite.image.server.map.geo.transformation.ControlPointManager;
import at.ait.dme.yuma.suite.image.server.map.geo.transformation.CoordinateTransformation;
import at.ait.dme.yuma.suite.image.server.map.geo.transformation.TransformationResult;
