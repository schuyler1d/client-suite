...
package at.ait.dme.yuma.suite.map.client.annotation;
...
import at.ait.dme.yuma.suite.image.core.client.tagcloud.TagSelectionListener;
import at.ait.dme.yuma.suite.image.core.client.tagcloud.annotation.TagEnabledAnnotationForm;
import at.ait.dme.yuma.suite.map.client.MapComponent;
import at.ait.dme.yuma.suite.map.client.MapUtils;
import at.ait.dme.yuma.suite.map.client.server.GeocoderService;
import at.ait.dme.yuma.suite.map.client.server.GeocoderServiceAsync;
