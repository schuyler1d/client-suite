...
import at.ait.dme.yuma.suite.core.client.image.ImageComposite;
import at.ait.dme.yuma.suite.core.client.image.StandardImageComposite;
import at.ait.dme.yuma.suite.core.client.image.annotation.ImageAnnotationComposite;
import at.ait.dme.yuma.suite.core.client.image.annotation.handler.selection.ImageAnnotationSelectionEvent;
import at.ait.dme.yuma.suite.core.client.image.annotation.handler.selection.ImageAnnotationSelectionHandler;
import at.ait.dme.yuma.suite.core.client.image.shape.ShapeTypeRegistry;
import at.ait.dme.yuma.suite.core.client.map.TiledImageComposite;
import at.ait.dme.yuma.suite.core.client.map.annotation.ControlPointComposite;
import at.ait.dme.yuma.suite.core.client.map.annotation.ControlPointForm;
import at.ait.dme.yuma.suite.core.client.map.explore.ExplorationComposite;
import at.ait.dme.yuma.suite.core.client.server.AuthenticationService;
import at.ait.dme.yuma.suite.core.client.server.AuthenticationServiceAsync;
import at.ait.dme.yuma.suite.core.client.server.exception.TilesetNotAvailableException;
import at.ait.dme.yuma.suite.core.client.tagcloud.annotation.TagEnabledAnnotationForm;
