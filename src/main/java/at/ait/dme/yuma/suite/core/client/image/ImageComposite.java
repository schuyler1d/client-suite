...
package at.ait.dme.yuma.suite.core.client.image;
...
import at.ait.dme.yuma.suite.core.client.image.annotation.handler.selection.HasImageAnnotationSelectionHandlers;
...
public abstract class ImageComposite extends Composite implements 
	...
	// Need to be properly implemented by ImageComposites which use the tag cloud
	public abstract TagCloud getTagCloud();
	public abstract void setAnnotationForm(TagEnabledAnnotationForm annotationForm);
}
