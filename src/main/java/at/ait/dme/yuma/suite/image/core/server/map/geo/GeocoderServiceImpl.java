...
package at.ait.dme.yuma.suite.image.core.server.map.geo;
...
import at.ait.dme.yuma.suite.image.core.client.map.annotation.WGS84Coordinate;
import at.ait.dme.yuma.suite.image.core.client.map.annotation.XYCoordinate;
import at.ait.dme.yuma.suite.image.core.client.server.GeocoderService;
import at.ait.dme.yuma.suite.image.core.client.server.exception.GeocoderException;
import at.ait.dme.yuma.suite.image.core.client.server.exception.TransformationException;
import at.ait.dme.yuma.suite.image.core.server.map.geo.transformation.AffineTransformation;
import at.ait.dme.yuma.suite.image.core.server.map.geo.transformation.ControlPointManager;
import at.ait.dme.yuma.suite.image.core.server.map.geo.transformation.CoordinateTransformation;
import at.ait.dme.yuma.suite.image.core.server.map.geo.transformation.TransformationResult;
